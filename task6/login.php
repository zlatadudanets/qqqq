<?php
// login.php – страница входа (восточный стиль)
session_start();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .emblem { font-size: 2.8rem; margin-bottom: 0.8rem; color: #8b694c; }
        h1 {
            font-size: 1.7rem;
            font-weight: 400;
            letter-spacing: 3px;
        ...
        input:focus { border-color: #b28b6f; background: #ffffff; }
        .error-banner {
            background: #fef0e8;
        ...
        .btn:hover { background: #e8ddd0; border-color: #8b694c; letter-spacing: 4px; }
        .links { margin-top: 1.5rem; font-size: 0.75rem; letter-spacing: 1px; }
        .links a { color: #9e7b5e; text-decoration: none; border-bottom: 0.5px dotted #dacbb8; transition: color 0.2s; }
        .links a:hover { color: #6a4e2e; border-bottom-color: #8b694c; }
        .hanko { margin-top: 1.8rem; font-size: 0.65rem; color: #b28b6f; letter-spacing: 2px; font-family: monospace; border-top: 0.5px solid #e2d5c4; padding-top: 1rem; width: 60%; margin-left: auto; margin-right: auto; }
