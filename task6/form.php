<?php
// form.php – анкета (восточный стиль)
session_start();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .field-error input, .field-error select, .field-error textarea { border-color: #c9826b; background: #fffaf5; }
        .error-msg {
            font-size: 0.7rem;
            color: #b16245;
            margin-top: 0.3rem;
        ...
        .error-msg::before { content: "・"; font-size: 0.8rem; color: #b87c4f; }
        textarea { min-height: 90px; resize: vertical; }
        select[multiple] { height: 150px; background: #fefaf5; }
        select[multiple] option:checked { background: #e8ddd0 linear-gradient(0deg, #dccbb8 0%, #dccbb8 100%); color: #4a2e1a; }
        .radio-group { display: flex; gap: 1.8rem; flex-wrap: wrap; align-items: center; margin-top: 0.3rem; }
        ...
        input[type="radio"], input[type="checkbox"] { accent-color: #b87c4f; width: auto; margin: 0; }
        .btn {
            width: 100%;
        ...
        .btn:hover { background: #e8ddd0; border-color: #8b694c; color: #3e2a1a; letter-spacing: 4px; }
        .success-banner {
            background: #efe4d8;
        ...
        .credentials-banner h3 { font-size: 0.9rem; color: #6a4e2e; margin-bottom: 0.5rem; letter-spacing: 1px; }
        .credentials-banner p { font-size: 0.75rem; color: #9e7b5e; margin-bottom: 0.8rem; }
        .cred-row { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; }
        .cred-label { color: #8b694c; font-size: 0.75rem; width: 60px; letter-spacing: 1px; }
        .cred-row strong { font-family: monospace; font-size: 0.85rem; background: #efe4d8; padding: 0.2rem 0.6rem; color: #6a4e2e; font-weight: normal; }
        .btn-login {
            display: inline-block;
            margin-top: 0.8rem;
        ...
        .btn-login:hover { background: #e8ddd0; border-color: #8b694c; letter-spacing: 3px; }
        .hanko { text-align: center; margin-top: 1.8rem; font-size: 0.65rem; color: #b28b6f; letter-spacing: 2px; font-family: monospace; border-top: 0.5px solid #e2d5c4; padding-top: 1.2rem; width: 80%; margin-left: auto; margin-right: auto; }
