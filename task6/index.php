<?php
// index.php – главная страница (восточный стиль)
session_start();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .emblem { font-size: 3rem; margin-bottom: 0.8rem; color: #8b694c; }
        h1 {
            font-size: 1.8rem;
            font-weight: 400;
            letter-spacing: 3px;
        ...
        .user-greeting strong { color: #8b694c; font-weight: 500; }
        .btn {
            display: block;
            width: 100%;
            padding: 0.7rem;
        ...
        .btn-primary { background: rgba(210, 180, 140, 0.08); }
        .btn-primary:hover { background: #e8ddd0; border-color: #8b694c; letter-spacing: 3px; }
        .btn-secondary { border-color: #dacbb8; }
        .btn-secondary:hover { background: #f0e8de; border-color: #b28b6f; letter-spacing: 3px; }
        .btn-danger { border-color: #dbb8a8; }
        .btn-danger:hover { background: #f0e0d8; border-color: #b87c5a; letter-spacing: 3px; }
        .btn-admin { border-color: #dacbb8; font-size: 0.75rem; }
        .btn-admin:hover { background: #f0e8de; letter-spacing: 2px; }
        .divider { height: 0.5px; background: #e2d5c4; margin: 0.8rem 0 1.2rem; }
        .hanko { margin-top: 1.6rem; font-size: 0.65rem; color: #b28b6f; letter-spacing: 2px; font-family: monospace; border-top: 0.5px solid #e2d5c4; padding-top: 1rem; width: 70%; margin-left: auto; margin-right: auto; }
...
<div class="scroll-card">
    ...
    <?php else: ?>
        ...
        <div class="divider"></div>
        <a href="admin.php" class="btn btn-admin">⚙️ вход администратора</a>
    <?php endif; ?>
